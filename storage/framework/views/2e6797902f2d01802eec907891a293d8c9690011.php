<?php $__env->startSection('title',trans('Add Fund')); ?>
        ...
        <div class="main row">
            <div class="col-12">
                <div
                    ...
                    <h3 class="mb-0"><?php echo app('translator')->get('Add Fund'); ?></h3>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <form>
                                    ...
                                    <div class="box">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group mb-3 cutom__referal_input__group">
                                                <input type="text" class="form-control amount darkpurple__input__group__fixed" name="amount" <?php if($totalPayment != null): ?> value="<?php echo e($totalPayment); ?>" readonly <?php endif; ?>>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-custom text-white addCreateListingRoute btn-custom-rounded checkCalc"><?php echo app('translator')->get('Next'); ?></button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u304811494/domains/agromultichains.org/public_html/resources/views/themes/darkpurple/user/addFund.blade.php ENDPATH**/ ?>