...
<?php echo $__env->make('plugins', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        root.style.setProperty('--primary', '<?php echo e(config('basic.base_color')??'#7a5dc8'); ?>');
    </script>

</body>
</html>
<?php /**PATH /home/u304811494/domains/agromultichains.org/public_html/resources/views/themes/darkpurple/layouts/user.blade.php ENDPATH**/ ?>