                    ...
                    <div class="row">
                        <div class="col">
                            <div class="header-text-full">
                                <h3><?php echo app('translator')->get('Profile setting'); ?></h3>
                            </div>
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <h3 class="golden-text"><?php echo app('translator')->get(ucfirst($user->username)); ?> <sup><sapn class="badge badge-pill bg-outline-success badge_lavel_style text-white border-1"><?php echo e(@$user->rank->rank_lavel); ?></sapn></sup></h3>
                                    <h5> <?php echo app('translator')->get(@$user->rank->rank_name); ?></h5>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u304811494/domains/agromultichains.org/public_html/resources/views/themes/darkpurple/user/profile/myprofile.blade.php ENDPATH**/ ?>